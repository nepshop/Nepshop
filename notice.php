...
<style>
        ...
        /* Optional: Add a hover effect to the table rows */
        tr:hover {
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
          <a href="index.html" title="Home">
            <img src="items/logo.png" alt="Nepshop logo" style="border: none; width: 100px; height: auto; border-radius: 50%;" />
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
              <a class="nav-link" href="notice.php" target="_blank">Notice</a>
          </li>
            <li class="nav-item">
           <b>  <a class="nav-link" href="signup/index.php">Login/singup</a> </b>  
            </li> 
...
include "db_connect.php";
        ...
        print "<table width='95%' border='1'  cellpadding='5'>";
        print "<tr>

       <td align='center' style=' background-color:#1D1D36; color:white;'>HEADING</td>
       <td align='center' style=' background-color:#1D1D36; color:white;'>DATE</td>
       <td align='center' style=' background-color:#1D1D36; color:white;'>NOTICE</td>
       </tr>";
        while($res = mysqli_fetch_array($result))
              {
// this is comment code is for 1 line gap      print "<tr ><td colspan='3'>  </td></tr>";
              // print "<tr >";
        
        echo "<td class='cell-1'>$res[1]</td>";
        echo "<td class='cell-2'>$res[2]</td>";
        echo "<td class='cell-4' align='center' style='color:red; background-color:silver;'><font size=5><a href="."uploads/notice/"."$res[4]"." target='_blank'>"."<button class='download-button'>Download</button></a> </font></td>\n";
        echo "</tr>";
     }
    print "</table>\n";
    mysqli_close($con);
...
<footer id="footer" class="footer-1">
  ...
  <a class="btn" href="https://www.youtube.com/channel/UCmqTHXXMc2ZEcsvNjBVEp4g" target="_blank" style="display: inline-block; font-size: 1rem; background-color: white; color: black; padding: 8px 16px; border-radius: 5px; text-decoration: none;">Subscribe Now</a>
  </div>
  </div>
